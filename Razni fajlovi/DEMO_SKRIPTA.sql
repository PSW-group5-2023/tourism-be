...
INSERT INTO tours."Checkpoints"(
	"Id", "Name", "Description", "Image", "Latitude", "Longitude", "TourId", "Secret", "PositionInTour", "AchievementId")
	VALUES
     (-30, 'Ledinci', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://www.dnevnik.rs/sites/default/files/2021-08/15-1panorama%20ledinci%20mesna%20zajednica.jpg', 45.184834, 19.804383, -10, ' ', 0, 1),
     (-31, 'Ledinacko jezero', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://static.mondo.rs/Picture/1174346/jpeg/Ledinacko-jezero-6-.jpg?ts=2022-08-05T08:16:02',  45.165829, 19.805942, -10, ' ', 1, 1),
     (-32, 'Kraljeva stolica', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://planine.net/wp-content/uploads/2020/05/IMG_20200523_111201-1024x768.jpg',  45.157033, 19.810422, -10, ' ', 2, 1),
     (-33, 'Planinarski dom Iriski venac', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://upload.wikimedia.org/wikipedia/commons/4/41/Iri%C5%A1ki_venac%2C_Planinarski_dom_Vojvodina_002.jpg',  45.150496, 19.836962, -10, ' ', 3, 1);

INSERT INTO tours."Checkpoints"(
	"Id", "Name", "Description", "Image", "Latitude", "Longitude", "TourId", "Secret", "PositionInTour", "AchievementId")
	VALUES
     (-34, 'Gorski smesko', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://luftika.rs/media/2022/06/gorski-smesko-6.jpg', 45.183885, 19.822954, -11, ' ', 0, 1),
     (-35, 'Orlovo bojiste', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://www.mojnovisad.com/files/news/8/6/1/5861/5861-0-orlovo-bojiste5.jpg',  45.180546, 19.830671, -11, ' ', 1, 1);

INSERT INTO tours."Checkpoints"(
	"Id", "Name", "Description", "Image", "Latitude", "Longitude", "TourId", "Secret", "PositionInTour", "AchievementId")
	VALUES
     (-36, 'Beocin', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://luftika.rs/media/2021/07/lafarz-izvor-lafarge.rs_-e1625237928782.jpg', 45.205714, 19.721455, -12, ' ', 0, 1),
     (-37, 'Manastir Beocin', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://turizaminfo.com/wp-content/uploads/2020/12/beocin-2.jpg',  45.176438, 19.721971, -12, ' ', 1, 1),
     (-38, 'Dumbovacki vodopad', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://andrijanacojic.com/wp-content/uploads/2021/05/IMG_7377-scaled.jpg', 45.167307, 19.749811, -12, ' ', 2, 1),
     (-39, 'Planinarski dom Zmajevac', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://fastly.4sqi.net/img/general/600x600/462351721_xyUvWRCTBx3YwsYXFEaKCmNyH5gMpPI1umJ6VmJlM9o.jpg',  45.158855, 19.780774, -12, ' ', 3, 1);

INSERT INTO tours."Checkpoints"(
	"Id", "Name", "Description", "Image", "Latitude", "Longitude", "TourId", "Secret", "PositionInTour", "AchievementId")
	VALUES
     (-40, 'Strazilovo', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Stra%C5%BEilovo.JPG/1200px-Stra%C5%BEilovo.JPG',45.169030, 19.917235, -13, ' ', 0, 1),
     (-41, 'Grob Branka Radicevica', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://www.dnevnik.rs/sites/default/files/2017-08/spomenik%20b%20radicevic.jpg',  45.166700, 19.913735, -13, ' ', 1, 1),
     (-42, 'Planinarski dom Strazilovo', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://fruskac.net/sites/default/files/styles/locations/public/gallery/tourism/planinarski-dom-strazilovo-1.jpg?itok=Uf0kC7hm', 45.172525, 19.912712, -13, ' ', 2, 1);

INSERT INTO tours."Checkpoints"(
	"Id", "Name", "Description", "Image", "Latitude", "Longitude", "TourId", "Secret", "PositionInTour", "AchievementId")
	VALUES
     (-43, 'Planinarski dom Zmajevac', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://fastly.4sqi.net/img/general/600x600/462351721_xyUvWRCTBx3YwsYXFEaKCmNyH5gMpPI1umJ6VmJlM9o.jpg',45.157941,19.780674, -14, ' ', 0, 1),
     (-44, 'Manastir Vrdnik', 'Old town Ledinci in beautiful forest of Fruska Gora', 'https://upload.wikimedia.org/wikipedia/commons/f/f9/2006_Vrdnik_010.jpg',   45.128367, 19.784399, -14, ' ', 1, 1);
...
INSERT INTO tours."Checkpoints"(
	"Id", "Name", "Description", "Image", "Latitude", "Longitude", "TourId", "Secret", "PositionInTour", "AchievementId")
	VALUES
(-45, 'Prison Veternik', 'The District Prison Novi Sad is one of the largest prisons in Serbia, accommodating not only detainees under investigation in the Municipal and District Courts but also individuals serving short prison sentences. On average, the facility houses around 450 inmates, including both men and women.', 'https://ocdn.eu/images/pulscms/NDk7MDA_/2b5a5e05a4e9cb5967c3a6a61ed1018e.jpg', 45.303545, 19.817226, -1, 'Enjoy your imprisonment.', 6, 1),
(-46, 'Big Centar', 'At the BIG shopping center in Novi Sad, you can expect fantastic shopping, excellent gastronomic offerings, as well as entertainment and relaxation facilities. Visit us and discover a new shopping experience!', 'https://www.big-cee.com/wp-content/uploads/2022/10/BIG_NOVI-SAD_1-1-1.png.webp', 45.275805, 19.827572, -1, 'Enjoy your shopping.', 7, 1);
...
VALUES
    (-24, 'Ramonda', 'Description', 'https://via-ventura.com/images/fbfe1177-9740-434b-bcf1-8b2171a2c115.png', 3, '{}'),
    (-21, 'Maple Leaf', 'Description', 'https://via-ventura.com/images/07d3913a-9d23-482a-982a-82c7efd40af8.png', 2, '{}'),
    (-11, 'Garden Cart', 'Description', 'https://via-ventura.com/images/1e1c924b-2e6e-4f0e-a244-34a846c5130a.png', 1, '{}'),
    (-20, 'Honey jar', 'Description', 'https://via-ventura.com/images/eaa00682-5a2a-4203-9c02-6d889d9c5593.png', 2, '{-2,-10}'),
    (-4, 'Fertilizer', 'Description', 'https://via-ventura.com/images/e898e289-7f1e-475c-b71d-b0cbd3afea30.png', 0, '{}'),
    (-9, 'Watering Can', 'Description', 'https://via-ventura.com/images/e69ecd64-ac1f-4c7b-9a91-7f7341549d8d.png', 0, '{}'),
    (-17, 'Tulip', 'Description', 'https://via-ventura.com/images/5c9df78e-1663-4736-b884-876f5af02004.png', 1, '{}'),
    (-22, 'Tea', 'Description', 'https://via-ventura.com/images/f0a3bb6b-5134-42dd-b857-820571476b39.png', 2, '{-3,-13,-6}'),
    (-8, 'Rose', 'Description', 'https://via-ventura.com/images/c75cd820-1b12-4aa0-a9d1-b5dc37d0b53d.png', 0, '{}'),
    (-25, 'Squirrel', 'Description', 'https://via-ventura.com/images/170e85cf-5f20-4be8-a29c-52daea4b6d8e.png', 3, '{-1,-12}'),
    (-16, 'Orange', 'Description', 'https://via-ventura.com/images/aec406bb-e2f3-4ac3-89c0-29bbe8013a50.png', 1, '{}'),
    (-15, 'Oaktree', 'Description', 'https://via-ventura.com/images/668d5197-f712-4bca-b890-7b6a0d5d3e1e.png', 1, '{-11,-9,-4}'),
    (-14, 'Narcissus', 'Description', 'https://via-ventura.com/images/077bd25d-7c75-4d24-bd84-60bf5dda4f4d.png', 1, '{}'),
    (-5, 'Lemon', 'Description', 'https://via-ventura.com/images/c5331463-9417-42e5-ab6c-5ddc75c2fc93.png', 0, '{}'),
    (-6, 'Menta', 'Description', 'https://via-ventura.com/images/0fd74968-4921-41a5-b2b0-57e4f2b58d13.png', 0, '{}'),
    (-13, 'Hibiscus', 'Description', 'https://via-ventura.com/images/a1ec4944-4883-43d6-8034-036f2a8a133b.png', 1, '{}'),
    (-12, 'Hazelnut', 'Description', 'https://via-ventura.com/images/a00ac5d5-d9f5-4a1e-a4e2-03145d4490fc.png', 1, '{}'),
    (-18, 'Ginger', 'Description', 'https://via-ventura.com/images/88c30a5e-6514-46cd-81c7-b43acf67669b.png', 2, '{}'),
    (-23, 'Elixir', 'Description', 'https://via-ventura.com/images/0a24ae2d-0ce1-400b-bfd8-ca58923ebd82.png', 3, '{-18,-16,-5}'),
    (-3, 'Chamomile', 'Description', 'https://via-ventura.com/images/3aa76dd2-2ab3-45ae-8829-256b72bdce35.png', 0, '{}'),
    (-19, 'Bouquet', 'Description', 'https://via-ventura.com/images/6ee538a1-ee4a-42f0-b561-50f70487eadb.png', 2, '{-14,-8,-17}'),
    (-10, 'Black Locust', 'Description', 'https://via-ventura.com/images/f4cd358d-33e5-4802-90b4-0f30498e897a.png', 1, '{}'),
    (-2, 'Bee', 'Description', 'https://via-ventura.com/images/c33b8f42-d121-4562-b50e-674c42076c4b.png', 0, '{}'),
    (-1, 'Acorn', 'Description', 'https://via-ventura.com/images/759d9035-ad0e-4cd3-863f-3b70e49b4ea9.png', 0, '{}'),
    (-7, 'Oakleaf', 'Description', 'https://via-ventura.com/images/e86a00cc-7b12-4bfd-b70a-c81ece4d97a7.png', 0, '{}');
