...
INSERT INTO blog."Comments"(
    "Id", "UserId", "CreationDate", "Description", "LastEditDate", "BlogId")
VALUES (-2, -11, CURRENT_TIMESTAMP, 'ovo je drugi komentar ikad', CURRENT_TIMESTAMP, -22);
INSERT INTO blog."Comments"(
    "Id", "UserId", "CreationDate", "Description", "LastEditDate", "BlogId")
VALUES (-3, -21, CURRENT_TIMESTAMP, 'ovo je treci komentar ikad', CURRENT_TIMESTAMP, -21);